export default function Loading() {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-linear-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-gray-950 dark:via-indigo-950 dark:to-purple-950 px-4">
      {/* Very subtle moving background gradient (no custom keyframes needed) */}
      <div className="absolute inset-0 bg-linear-to-r from-indigo-500/5 via-purple-500/5 to-pink-500/5 animate-pulse opacity-60" />

      <div className="relative z-10 flex flex-col items-center gap-10">
        {/* Glowing Logo */}
        <div className="relative">
          <div className="h-20 w-20 rounded-2xl bg-linear-to-br from-indigo-500 to-purple-600 p-1 shadow-xl shadow-indigo-500/30 dark:shadow-purple-500/30 animate-pulse">
