    ...
    const services = [
        {
          ...
          description: "Complete assistance for Bachelor, Masters, and PhD programs in top Malaysian universities.",
        ...
        },
        {
          icon: FileCheck,
          title: "Student Visa",
          description: "End-to-end visa processing and guidance from A to Z for Malaysian student visas.",
        ...
        },
        {
          icon: Plane,
          title: "Tourist Visa",
          description: "Fast and reliable tourist visa services for Malaysia and other popular destinations.",
        ...
        },
        {
          icon: Ticket,
          title: "Air Ticket",
          description: "Affordable air ticket booking services for domestic and international travel.",
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            ...
            >
              {/* Icon Box */}
              <div className={`w-16 h-16 ${service.iconBg} rounded-2xl flex items-center justify-center mb-8 transition-transform group-hover:scale-110 duration-300`}>
