                ...
                <form className="space-y-6" onSubmit={handleWhatsAppSubmit}>
                    <div className="grid sm:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            <label className="text-sm font-semibold text-[#334155]">Your Name *</label>
                            <Input 
                                name="name"
                                required
                                value={formData.name}
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-semibold text-[#334155]">Interested Service *</label>
                        <select 
                            name="service"
                            required
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-semibold text-[#334155]">Your Message</label>
                        <Textarea 
                            name="message"
